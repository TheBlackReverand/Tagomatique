        ...
        private void AjouterDossier(bool relatif)
        {
            ...
            if (fbd.ShowDialog() == DialogResult.OK)
            {
                foreach (string file in Directory.GetFiles(fbd.SelectedPath))
                {
                    ...
                    Medias.Add(MediaViewModel.AjouterMedia(Path.GetFileName(file), directory, Guid.Empty, false, isValid));
                }
            }
        }
        ...
        private void AjouterFichier(bool relatif)
        {
            ...
            if (ofd.ShowDialog() == DialogResult.OK)
            {
                foreach (string file in ofd.FileNames)
                {
                    ...
                    Medias.Add(MediaViewModel.AjouterMedia(Path.GetFileName(file), directory, Guid.Empty, false));
                }
            }
        }
